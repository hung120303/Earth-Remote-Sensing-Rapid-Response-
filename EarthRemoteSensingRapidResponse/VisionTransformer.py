################################################################################################################
# Vision Transformer Test file                                                                                 #
#   - based on example given by https://keras.io/examples/vision/image_classification_with_vision_transformer/ #
################################################################################################################
...
image_size = 72 # input images are reszed to this
patch_size = 6  # size of patches to extract from input images
...
mlp_head_units = [
    2048,
    1024,
] # size of dense layers for final classifier
...
###########################################################
def display_patch():
        # display patch(es) as a sample image
