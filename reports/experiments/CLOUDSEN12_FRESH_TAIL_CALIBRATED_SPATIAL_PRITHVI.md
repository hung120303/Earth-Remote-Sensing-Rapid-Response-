...
- Available rows: **368**; unavailable: **6**.
- Current false positives: **4**; candidate: **4**.
- Current/candidate p95: **0.022308 / 0.021549**.
- Frozen logit offset: **-0.105610**.
- All safety gates pass: **false**.
