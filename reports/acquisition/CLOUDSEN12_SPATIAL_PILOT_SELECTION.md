...
- Eligible all-clear, spatially disjoint rows: **8,999**.
- Auxiliary training: **384** rows.
- Development: **128** rows.
- Countries represented: **176**.
- Minimum observed distance to a MARS emitter: **27.64 km**.
- Sealed CloudSEN12 test rows selected/accessed: **0**.
