...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        ...
        (
            ...
            if fresh_external_test
            else "- Explicit clear-scene negatives require an identically gridded zero plume mask."
            if negative_only
        ...
        (
            ...
            if fresh_external_test
            else "- Published CloudSEN12+ all-clear labels remain the negative cloud contract."
            if negative_only
        ...
        (
            ...
            if fresh_external_test
            else "- Sealed-external samples were excluded."
        ),
        "",
    ]
